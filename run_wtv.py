...
model_with_loss = gensim.models.Word2Vec(
    sentences, min_count=1, compute_loss=True, hs=0, sg=1, seed=42
)
    ...
    for sg_val in sg_values:
        for hs_val in hs_values:
            for loss_flag in [True, False]:
                ...
                print(
                    "Word2vec model #%i: %s"
                    % (len(train_time_values), model_result)
                )
...
most_similars_precalc = {
    word: model.wv.most_similar(word) for word in model.wv.index2word
}
